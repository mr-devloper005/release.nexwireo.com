...
export const editableRootStyle = {
  '--slot4-page-bg': '#dff6fb',
  '--slot4-page-text': '#050b12',
  '--slot4-panel-bg': '#e9f7fa',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#314a58',
  '--slot4-soft-muted-text': '#6c7e87',
  '--slot4-accent': '#38c3cc',
  '--slot4-accent-fill': '#38c3cc',
  '--slot4-accent-soft': '#c9f4f7',
  '--slot4-dark-bg': '#08263b',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#d7edf3',
  '--slot4-cream': '#e7f8fc',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#006d86',
  '--slot4-gray': '#e8eef1',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #e4f8fc 42%, #ffffff 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  button: {
    primary: `inline-flex items-center justify-center gap-2 rounded-full bg-[var(--slot4-dark-bg)] px-7 py-3.5 text-sm font-black text-white transition hover:bg-[var(--slot4-accent-fill)] hover:text-black`,
    secondary: `inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#006d86] bg-transparent px-7 py-3.5 text-sm font-black text-[#006d86] transition hover:bg-[#006d86] hover:text-white`,
    accent: `inline-flex items-center justify-center gap-2 rounded-full bg-[var(--slot4-accent-fill)] px-7 py-3.5 text-sm font-black text-black transition hover:bg-[var(--slot4-dark-bg)] hover:text-white`,
  },
  media: {
...
export const aiLayoutRules = [
  ...
  'Prioritize readable desktop and mobile layouts with broad release columns and a focused media update measure.',
